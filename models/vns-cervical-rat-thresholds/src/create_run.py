...
if __name__ == "__main__":
    ...
    parser.add_argument('--start-index', type=int, default=0, help='The starting index of the samples')
    parser.add_argument('--dest', type=str, default='.', help='The destination of the configs')
    
    args = parser.parse_args()
    n_index = args.start_index
    ...
    shutil.copy(f'{DIR}/sim_0.json', f'{dest}/config/user/sims/5.json')
    shutil.copy(f'{DIR}/sim_1.json', f'{dest}/config/user/sims/6.json')