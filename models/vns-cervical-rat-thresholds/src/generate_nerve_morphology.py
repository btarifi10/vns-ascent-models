    ...
    for _ in range(n_samples):
        while True:
            try:
                ...
                nerve_diameter = get_truncated_normal(mean=nerve_mean_diameter, sd=nerve_sd_diameter, low=nerve_mean_diameter-2*nerve_sd_diameter, upp=nerve_mean_diameter+2*nerve_sd_diameter, size=1)[0]
