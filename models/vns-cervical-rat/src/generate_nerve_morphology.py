...
def generate_nerve_histology_samples(n_samples, nerve_mean_diameter, nerve_sd_diameter, fascicle_mean_diameter, fascicle_sd_diameter):
    ...
    for _ in range(n_samples):
        ...
        # Ensure fascicle fits inside the nerve
        max_offset_x = nerve_a - fascicle_a
        max_offset_y = nerve_b - fascicle_b
        ...
        while True:
            ...
            if (fascicle_x**2 / (nerve_a - fascicle_a)**2 + fascicle_y**2 / (nerve_b - fascicle_b)**2) <= 1:
                break
